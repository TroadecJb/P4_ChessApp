...
from models import turnament, player
...
class Controller_db:
    """Search for data, add player(s) to database table"""
    ...
    def save(serialize_data, table):
        table.insert(serialize_data.serialized)

    def update(serialize_data, table):
        pass
